...
class RuleMiner(object):
    ...
    def get_confidence(self, data, rule):
        ...
        support_1 = self.get_support(data, sub_x)
        support_2 = self.get_support(data, X)

        confidence = support_1 / support_2
    ...
    def get_association_rules(self, data):
        ...
        for itemset in itemsets:
            ...
            # class.
            item_rules = self.get_rules(itemset)
        ...
        for rule in rules:
            ...
            # this class.
            confidence_rule = self.get_confidence(data, rule)

            if confidence_rule >= self.confidence_t:
